...
namespace CasaDoCodigo
{
    ...
    public class HttpHelper : IHttpHelper
    {
        ...
        public int? GetPedidoId()
        {
            ...
            return contextAccessor.HttpContext.Session.GetInt32(clienteId);
        }
        ...
        private string GetClienteId()
        {
            ...
            return $"pedidoId_{clienteId}";
        }

        public void SetPedidoId(int pedidoId)
        {
            string clienteId = GetClienteId();
            contextAccessor.HttpContext.Session.SetInt32(clienteId, pedidoId);
        }

        public void ResetPedidoId()
        {
            string clienteId = GetClienteId();
            contextAccessor.HttpContext.Session.Remove(clienteId);
        }
